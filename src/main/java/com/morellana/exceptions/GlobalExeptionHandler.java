package com.morellana.exceptions;

import com.morellana.dto.ApiResponse;
...
public class GlobalExeptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleUnownException(Exception ex){
    ...
    public ResponseEntity<ApiResponse<?>> handleBadRequestException(BadRequestException ex){
        ...
        log.error("Bad RequestException: {}", ex.getMessage());
